          ...
          {industries.map((ind, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group w-[160px] md:w-[200px] aspect-square rounded-3xl glass-panel flex flex-col items-center justify-center gap-4 hover:-translate-y-2 transition-all duration-300 border-white/10 hover:border-white/20 cursor-pointer shadow-[0_10px_30px_rgba(0,0,0,0.2)] hover:shadow-[0_20px_40px_rgba(79,140,255,0.15)] relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="w-14 h-14 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-accent/20 group-hover:text-white transition-colors text-white relative z-10">
