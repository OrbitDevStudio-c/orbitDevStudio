...
export default function TechCategories() {
  return (
    <section className="bg-white px-6 py-24 text-slate-950 md:px-12 lg:px-24">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {categories.map(({ name, detail, Icon }, index) => (
            <motion.article
              ...
              className="rounded-lg border border-slate-200 bg-slate-50 p-5 transition-colors hover:border-accent/40 hover:bg-white"
            >
