        ...
        <div className="flex w-[200%]">
          ...
          >
            {[...skillsRow1, ...skillsRow1, ...skillsRow1].map((skill, index) => (
              <div 
                key={index}
                className="px-6 py-3 rounded-full bg-white border border-slate-200 shadow-sm whitespace-nowrap text-sm font-semibold text-slate-600 hover:border-[#4F8CFF] hover:text-[#4F8CFF] transition-colors cursor-default"
              >
                {skill}
              </div>
            ))}
        ...
        <div className="flex w-[200%] justify-end">
          ...
          >
            {[...skillsRow2, ...skillsRow2, ...skillsRow2].map((skill, index) => (
              <div 
                key={index}
                className="px-6 py-3 rounded-full bg-white border border-slate-200 shadow-sm whitespace-nowrap text-sm font-semibold text-slate-600 hover:border-emerald-500 hover:text-emerald-500 transition-colors cursor-default"
              >
                {skill}
              </div>
            ))}
