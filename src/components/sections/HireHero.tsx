    ...
    <section className="relative w-full min-h-[90vh] bg-gradient-to-br from-[#152A5A] to-[#132E7B] flex items-center pt-24 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center h-full">
        ...
        >
          ...
          <div className="absolute right-20 top-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#2E5BE5] rounded-full blur-[100px] opacity-20" />
          ...
          <div className="relative w-full max-w-[500px] h-[450px]">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-32 h-32 rounded-3xl bg-white/10 border border-white/20 backdrop-blur-xl flex items-center justify-center shadow-[0_0_60px_rgba(46,91,229,0.4)]">
               <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-[#1B3675] to-[#2E5BE5] flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="absolute right-4 top-[10%] z-20 bg-[#0B1736]/80 backdrop-blur-md border border-[#4F8CFF]/30 p-4 rounded-2xl shadow-2xl flex items-center gap-3 w-48"
            >
              <div className="w-12 h-12 rounded-full bg-blue-500/20 flex items-center justify-center border border-blue-500/30 shrink-0">
                <Terminal size={20} className="text-[#4F8CFF]" />
              </div>
            ...
            <motion.div 
              ...
              className="absolute left-0 top-[20%] z-20 bg-[#0B1736]/80 backdrop-blur-md border border-white/10 p-4 rounded-2xl shadow-2xl flex items-center gap-3 w-44"
            >
            ...
            <motion.div 
              ...
              className="absolute left-1/2 bottom-[5%] -translate-x-1/2 z-20 bg-[#0B1736]/90 backdrop-blur-md border border-emerald-500/30 p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-3 w-52"
            >
