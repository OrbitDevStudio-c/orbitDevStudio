            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-white light:text-slate-900 group-hover:text-white group-hover:scale-110 light:group-hover:text-slate-900 transition-all duration-300">
                    <Icon size={24} strokeWidth={1.5} />
                  </div>
                  <h3 className="text-xl font-bold text-white light:text-slate-900 mb-3 tracking-wide">{reason.title}</h3>
